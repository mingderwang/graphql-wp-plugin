<?php
/**
 * Graphql_wp_plugin Test Bootstrapper.
 *
 * @since   0.0.1
 ...
 * @since 0.0.1
 */
function _manually_load_graphql_wp_plugin_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/graphql-wp-plugin.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_graphql_wp_plugin_plugin' );
